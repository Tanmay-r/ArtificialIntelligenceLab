...
public:
		...
		virtual void redirectPointer(state* succ, state* curr, state* goal); //checks if monotone then doesnot redirect children of succ
};
...
public:
	...
	void redirectPointer(state* succ, state* curr, state* goal); //checks if monotone then doesnot redirect children of succ
};
