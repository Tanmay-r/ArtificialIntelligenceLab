...
strarr = sys.argv
if(strarr[1]=="1"):
	inputArray = buildInput.buildInput(6)
	outputArray = functions.f_Parity(inputArray)
	backpropagation(np.array([7, 7, 1]), inputArray, outputArray)
elif (strarr[1]=="2"):
	inputArray = buildInput.buildInput(2)
	outputArray = functions.f_XOR(inputArray)
	backpropagation(np.array([3, 3, 1]), inputArray, outputArray)
elif (strarr[1]=="3"):
	inputArray = buildInput.buildInput(2)
	...
	backpropagation(np.array([6, 6, 1]), inputArray, outputArray)
elif (strarr[1]=="5"):
	inputArray = buildInput.buildInput(5)
